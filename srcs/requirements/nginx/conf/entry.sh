...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout ${SSL_CERTIFICATE_KEY} -out ${SSL_CERTIFICATE} -subj "/C=US/ST=SomeState/L=SomeCity/O=SomeOrganization/CN=rmehadje.42.fr";
